...
public class ReservaTest {
    ...
    void toStringDevuelveLaCadenaEsperada() {
        ...
        String cadenaEsperada=String.format("Huésped: %s %s Habitación:%s Fecha Inicio Reserva: %s Fecha Fin Reserva: %s Checkin: %s Checkout: %s Precio: %.2f Personas: %d",
        ...
        cadenaEsperada=String.format("Huésped: %s %s Habitación:%s Fecha Inicio Reserva: %s Fecha Fin Reserva: %s Checkin: %s Checkout: %s Precio: %.2f Personas: %d", reserva.getHuesped().getNombre(), reserva.getHuesped().getDni(),
                reserva.getHabitacion(), reserva.getFechaInicioReserva().format(formatoFecha),
